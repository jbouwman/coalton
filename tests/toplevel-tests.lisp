    ...
    (check-parse
     ...
     (lambda (form file)
       (let* ((pkg-a (coalton-impl/parser/toplevel::parse-package form file))
              (lisp-pkg-a (coalton-impl/parser/toplevel::lisp-package pkg-a file)))
         ...
         (check-parse
          ...
          (lambda (form file)
            (let* ((pkg-b (coalton-impl/parser/toplevel::parse-package form file))
                   (lisp-pkg-b (coalton-impl/parser/toplevel::lisp-package pkg-b file)))
    ...
    (check-parse
     ...
     (lambda (form file)
       (let ((package (coalton-impl/parser/toplevel::parse-package form file)))
         (coalton-impl/parser/toplevel::lisp-package package file))))))
