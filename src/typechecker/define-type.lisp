  ...
  (check-duplicates
   ...
   (lambda (first second)
     (tc:tc-error "Duplicate type definitions"
                  (make-note (parser:type-definition-location first)
                             "first definition here")
                  (make-note (parser:type-definition-location second)
  ...
  (check-duplicates
   ...
   (lambda (first second)
     (tc:tc-error "Duplicate constructor definitions"
                  (make-note (parser:type-definition-ctor-location first)
                             "first definition here")
                  (make-note (parser:type-definition-ctor-location second)
                             "second definition here"))))
        ...
        :do (check-duplicates
             ...
             (lambda (first second)
               (tc:tc-error "Duplicate type variable definitions"
                            (make-note (parser:keyword-src-location first)
                                       "first definition here")
                            (make-note (parser:keyword-src-location second)
                                       "second definition here")))))
