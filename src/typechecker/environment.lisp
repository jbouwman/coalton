...
(defmethod make-source-form ((entry name-entry))
  `(make-name-entry :name ',(name-entry-name entry)
                    :type ,(name-entry-type entry)
                    ,@(when (name-entry-docstring entry)
                        (list :docstring (name-entry-docstring entry)))
                    ,@(when (name-entry-location entry)
                        (list :location (name-entry-location entry)))))
