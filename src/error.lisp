...
(defun make-coalton-error-note (&rest args)
  (apply #'note args))

(defun make-coalton-error-help (&rest args)
  (apply #'help args))

(defun make-coalton-error-context (&rest args)
  (apply #'context args))
